  ...
  return (
    ...
    <div className='landingimgbgmb h-[100vh]'>
        <div className="flex justify-center items-center">
           ...
           <input type="email" name="email" id="email" onChange={e => setEmail(e.target.value)} className='w-[100%] px-[10px] py-[5px] border-[1px] border-solid outline-orange rounded-[5px]' placeholder='Enter email address' />
           </div>
           <div className="py-[10px]">
           <label htmlFor="password" className='text-[19px] font-[500]'>Password</label>
            <input type="password" name="password" id="password" onChange={e => setPassword(e.target.value)} className='w-[100%] px-[10px] py-[5px] border-[1px] border-solid outline-orange rounded-[5px]' placeholder='Enter password' />
            </div>
